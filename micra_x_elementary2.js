(function(ext){
  ...
  var descriptor = {
    blocks: [
        ...
        [" ", "周囲をリセット", "ResetHere"],
        [" ", "原点でリセット", "Reset"],
        [" ", "%s の円 x:%n y:%n z:%n 半径:%n で%m.Pit", "pre_drawCircle"," ",0,0,0,10,"ねかす"],
        [" ", "%s の弧 x:%n y:%n z:%n 半径:%n で%m.Rot ° 開いて%m.Pit", "pre_drawArc"," ",0,0,0,10,"180","立てる"],
        [" ", "%s のおうぎ x:%n y:%n z:%n 半径:%n で%m.Rot ° 開いて%m.Pit", "pre_drawArcRadis"," ",0,0,0,10,"180","ねかす"],
        [" ", "%s の立方体 x:%n y:%n z:%n 大きさ:%n", "pre_drawCube"," ",0,0,0,10],
        [" ", "%s の球 x:%n y:%n z:%n 半径:%n", "pre_drawBall"," ",0,10,0,10],
        [" ", "%s のだ円板 x:%n y:%n z:%n 半径:%n で%m.Pit", "pre_drawEllipse"," ",0,0,0,10,"ねかす"],
